...
def twiddle(tol=0.2):  # PID parameter optimization
    ...
    while (sum(dp) >=tol):
        print 'Twiddle ', count
        print 'params = ', params, best_error
...
#
#     previous_error = myrobot.y
#     sum_error = 0.0
#     for i in range(N):
#         error = myrobot.y
#         diff_error = error - previous_error
#         sum_error += error
#         steering = - (param1*error + param2*diff_error + param3*sum_error)
