...
def smooth(path, weight_data=0.1, weight_smooth=0.1, tolerance=0.00001):
    ...
    while change >= tolerance:
        ...
        for i in range(len(newpath)):
            ...
            newpath2[i][0] += weight_data * (path[i][0] - newpath2[i][0]) + weight_smooth * (newpath2[(i + 1) % len(newpath2)][0] + newpath2[(i - 1) % len(newpath2)][0] - 2 * newpath2[i][0])
            newpath2[i][1] += weight_data * (path[i][1] - newpath2[i][1]) + weight_smooth * (newpath2[(i + 1) % len(newpath2)][1] + newpath2[(i - 1) % len(newpath2)][1] - 2 * newpath2[i][1])
